...
@section('content')
<div id="content">
    <h1 style="font-size: 3.25rem; padding-top: 5vh;"><b>{{__('lang.Register: Entrepreneur')}}</b></h1>
    <br>
    <p style="font-size:  1.4rem; padding-left: 2.5vw;">
        {{__('lang.Entrepreneur-register-header')}}
    </p>
        ...
        <div class="col-md-7 col-sm-12 order-md-1" style="padding-left: 6%; padding-right: 6%; padding-top: 6vh;">
            <form id="register-form" action="{{route('user.entrepreneur.store')}}" method="POST">
                ...
                <div class="form-container">
                    ...
                    <div class="form-group">
                        <input type="email" class="form-control @error('email') is-invalid @enderror" id="form-email" aria-describedby="Email" placeholder="{{__('lang.Email')}}" name="email">
                        @error('email')
                            <span class="invalid-feedback" role="alert">
                                <strong>{{ $message }}</strong>
                            </span>
