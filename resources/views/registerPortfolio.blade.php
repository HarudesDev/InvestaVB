...
@section('content')
<div id="content">
    <h1 style="font-size: 3.25rem; padding-top: 5vh;"><b>Registro: Inversionista</b></h1>
    <br>
        ...
        <div class="col-md-7 col-sm-12 order-md-1" style="padding-left: 6%; padding-right: 6%; padding-top: 6vh;">
            <form id="register-form" action="{{route('user.portfolio.store')}}" method="POST">
                ...
                <div class="form-container">
                    ...
                    <div class="form-group">
                        <input type="email" class="form-control @error('email') is-invalid @enderror" id="form-email" aria-describedby="Email" placeholder="Email corporativo" name="email">
                        @error('email')
                            <span class="invalid-feedback" role="alert">
                                <strong>{{ $message }}</strong>
                            </span>
